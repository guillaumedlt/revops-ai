...
export default function TemplatesPopover({ onSelect }: TemplatesPopoverProps) {
  ...
  if (!open) {
    return (
      <button onClick={function() { setOpen(true); }} type="button"
  ...
  return (
    <div ref={containerRef} className="absolute bottom-full left-0 mb-2 w-[380px] rounded-xl border border-[#E5E5E5] bg-white shadow-lg z-50 overflow-hidden">
      {/* Header + Search */}

                ...
                <div className="rounded-lg border border-[#EAEAEA] bg-white p-5 md:p-8 shadow-[0_4px_20px_-8px_rgba(0,0,0,0.06)]">
                  ...
                  <div className="mt-5 space-y-3">
                    {[
                      ...
                      { critere: "Gestion de territoire", hubspot: "Basique (equipes et vues). Pas de territory management natif.", salesforce: "Territory Management Enterprise natif. Yesterdayarchies, regles d'attribution, forecasting par territoire.", winner: "Salesforce", winColor: "#00A1E0" },
                    ].map((r) => (

              ...
              <section id="signaux" className="mb-8">
                <div className="rounded-lg border border-[#EAEAEA] bg-white p-5 md:p-8 shadow-[0_4px_20px_-8px_rgba(0,0,0,0.06)]">
                  ...
                  <div className="mt-5 space-y-3">
                    {[
                      { metric: "Churn mensuel > 5%", desc: "Vous perdez plus de la moitie de vos clients chaque annee. Aucune croissance ne compense un tel niveau d&apos;attrition. Priorite absolue : comprendre pourquoi les clients partent avant de chercher a en acquerir de nouveaux.", level: "Critical", color: "#EF4444" },
                      { metric: "CAC payback > 18 mois", desc: "Chaque client vous coute plus cher a acquerir qu&apos;il ne vous rapporte pendant un an et demi. Votre tresorerie est sous pression constante. Revoyez vos canaux d&apos;acquisition ou augmentez vos prix.", level: "Critical", color: "#EF4444" },

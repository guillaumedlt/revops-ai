              ...
              <section id="cinq-chantiers" className="mb-8">
                <div className="rounded-lg border border-[#EAEAEA] bg-white p-5 md:p-8 shadow-[0_4px_20px_-8px_rgba(0,0,0,0.06)]">
                  ...
                  <div className="mt-6 space-y-3">
                    {[
                      { num: "01", title: "Centraliser toutes les donnees dans le CRM", impact: "Critical", effort: "1-2 jours", desc: "Plus aucun contact, aucun deal, aucune interaction ne vit en dehors du CRM. Migration des spreadsheets, import des contacts, nettoyage des doublons. C&apos;est le fondement de tout le reste.", color: "#22C55E" },
                      { num: "02", title: "Definir le pipeline et les etapes de vente", impact: "Critical", effort: "0.5 jour", desc: "5 a 7 etapes avec des criteres d&apos;entree et de sortie clairs. Formation de l&apos;equipe. Weekly reviewmadaire du pipeline. Le pipeline est l&apos;outil de pilotage numero un.", color: "#22C55E" },
                      ...
                      { num: "04", title: "Automatiser les taches repetitives", impact: "Fort", effort: "2-4 semaines", desc: "Commencer par les quick wins : notifications de nouveaux leads, relances automatiques pour les deals en overdue, attribution automatique. Chaque automatisation liberee du temps commercial pur.", color: "#FF7A59" },

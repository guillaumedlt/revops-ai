              ...
              <section id="pourquoi" className="mb-8">
                <div className="rounded-lg border border-[#EAEAEA] bg-white p-5 md:p-8 shadow-[0_4px_20px_-8px_rgba(0,0,0,0.06)]">
                  ...
                  <div className="space-y-3 text-[13px] text-[#555] leading-[1.75]">
                    ...
                    <p>L&apos;enrichissement de donnees B2B consiste type to complete automatiquement les informations de vos prospects : email professionnel, numero de telephone, poste actuel, taille de l&apos;entreprise, technologies utilisees, signaux d&apos;achat. C&apos;est la brique fondamentale de toute strategie outbound moderne.</p>

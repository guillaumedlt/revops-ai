              ...
              <section id="fonctionnalites-crm" className="mb-8">
                <div className="rounded-lg border border-[#EAEAEA] bg-white p-5 md:p-8 shadow-[0_4px_20px_-8px_rgba(0,0,0,0.06)]">
                  ...
                  <div className="space-y-3 text-[13px] text-[#555] leading-[1.75]">
                    ...
                    <p><strong className="text-[#111]">Activites et taches.</strong> Pipedrive excelle sur la gestion des activites. L&apos;outil est construit autour du concept d&apos;&ldquo;activity-based selling&rdquo; : chaque deal doit toujours avoir une prochaine activite planifiee, et l&apos;interface rappelle constamment aux commerciaux quand ils ont des taches en overdue. HubSpot propose un systeme de taches equivalent mais moins central dans l&apos;experience utilisateur.</p>
                  </div>
                  ...
                  <div className="mt-4 grid grid-cols-1 sm:grid-cols-2 gap-3">
                    {[
                      ...
                      { label: "Deal scoring", hubspot: "Predictif IA (Enterprise)", pipedrive: "Manual uniquement" },

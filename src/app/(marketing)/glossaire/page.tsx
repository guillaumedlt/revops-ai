...
const terms: Term[] = [
  ...
  // I
  { term: "ICP (Ideal Customer Profilee)", slug: "icp", definition: "Profile du client ideal au niveau entreprise : secteur, taille, revenu, technologie, maturite. L\u2019ICP se definit en analysant les meilleurs clients existants et guide toute la strategie d\u2019acquisition.", category: "revops", related: ["ABM", "Buyer Persona", "Segmentation"], blogLink: "/blog/account-based-marketing-guide" },
  ...
  // T
  { term: "Time to Value", slug: "time-to-value", definition: "Temps necessaire pour qu\u2019un nouveau client obtienne de la valeur avec votre produit. Show less le time-to-value ameliore la retention et le NPS.", category: "crm", related: ["Onboarding", "Churn", "NPS"] },
  ...
  { term: "UTM", slug: "utm", definition: "Settings ajoutes aux URLs pour tracker l\u2019origine du trafic : utm_source, utm_medium, utm_campaign, utm_content, utm_term. Indispensables pour l\u2019attribution marketing.", category: "data", related: ["Attribution", "Conversion", "GA4"], blogLink: "/blog/tracking-conversions-hubspot-guide-complet" },
